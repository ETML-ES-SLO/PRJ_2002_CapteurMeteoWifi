...
{     
    ...
    if(Struct_save.Wifi_save.Magic == 0x1234)
    {
        ...
        memmove(Wifi.IPDom, Struct_save.Wifi_save.IPDom, sizeof(Struct_save.Wifi_save.IPDom));
        memmove(Wifi.PortDom, Struct_save.Wifi_save.PortDom, sizeof(Struct_save.Wifi_save.PortDom));
    }
    else
    {
        ...
        memmove(Wifi.IPDom, "192.168.0.104", strlen("192.168.0.104"));
        memmove(Wifi.PortDom, "8080", strlen("8080"));
    }
...
{  
    ...
    if(ESP8266_ConnectToTCPServer(Wifi.IPDom,Wifi.PortDom) == OK)
    {
