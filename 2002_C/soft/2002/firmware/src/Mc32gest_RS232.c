...
* Sortie :      rien                                                           *
* Desription :  Cette fonction permet de récupérer tous les caractères se      *
...
int8_t GetWifiMessage(int8_t *pDataRX, char* CompareStr, uint32_t nbMsWait)
{
    ...
    do{
        //vérifie le nombre de caractère dans le fifoSW
        ...
        {  
           ...
           {
               //si oui, teste si dans la trame il y a les même caractère que l'on veut
               ...
               //si oui, teste sur le message ERROR a été reçu 
...
* Entrée :      char expectedChar                                              *                                                                      
* Sortie :      code de retour OK/ERROR/NO_DATA/TIMEOUT                        *
* Desription :  Contrôle dans le buffer de réception si le caractère voulu     *
*               est présent                                                    *                              *
* Remarques:    Voir le prototype dans Mc32gest_RS232.h                        *
*******************************************************************************/
int8_t ReadSingleCharFromUsb(char expectedChar)
{
    ...
    if(rxBufLvl > 0)
    {
        //cherche caractère dans buffer local
...
int8_t ReadStrFromUsb(char* pStr)
{
    ...
    if(rxBufLvl > 0)
    {
        ...
        return (NO_DATA);   //ni validé par enter, ni escape ==> pas de data à analyser
    }
    else
        return (NO_DATA);   //buffer vide      
}
...
//            charCntr++;
//        }
//        //test si dans la trame il y a les même caractère que l'on veut
//        if (strstr((char*)pDataRX, CompareStr) != 0)
//        {
...
//        }        
//    }
//    //sinon, test si dans l'ancienne trame il y a les même caractère que l'on veut 
...
* Entrée :  int8_t *pDataTX donnees a envoyer                                  *
*           int8_t NbByte taille des donnees. Si < 0, envoie jusqu'a           *
*             rencontrer caractere 0                                           *                                                                      
* Sortie :      rien                                                           *
* Desription :  Cette fonction permet de mettre les caractères dans le fifo SW *
*               de l'USB.                                                      *
* Remarques:    Voir le prototype dans Mc32gest_RS232.h                        *
*******************************************************************************/
...
//    static uint8_t i = 0;
    ...
    {            
        ...
        //  S'il y a un caractères à émettre dans le fifo
