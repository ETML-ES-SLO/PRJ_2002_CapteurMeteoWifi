...
{
    static float Pression[10] = {0}, PressionDiff[9] = {0};
    float PressionMoy = 0;
    uint8_t cPression;
    int8_t cMoyenne;
    ...
    for(cPression = 10; cPression >= 1; cPression--)
    {
    ...
    //dérivé des mesures en fonction du temps entre chaques mesures
    PressionDiff[0] = (Pression[0] - Pression[1])/0.3;
    PressionDiff[1] = (Pression[0] - Pression[2])/0.6;
    PressionDiff[2] = (Pression[0] - Pression[3])/1;
    PressionDiff[3] = (Pression[0] - Pression[4])/1.3;
    PressionDiff[4] = (Pression[0] - Pression[5])/1.6;
    PressionDiff[5] = (Pression[0] - Pression[6])/2;
    PressionDiff[6] = (Pression[0] - Pression[7])/2.3;
    PressionDiff[7] = (Pression[0] - Pression[8])/2.6;
    PressionDiff[8] = (Pression[0] - Pression[9])/3;
    
    //moyenne de toutes les dérivées calculées
    for(cMoyenne = 0; cMoyenne <= 8; cMoyenne++)
    {
        PressionMoy += PressionDiff[cMoyenne];
    }
    PressionMoy /= 9;
    ...
    if(Pression[9] != 0)
    {
        ...
        //test si la moyenne calculées est plus grande ou égale que -1.5hPa
