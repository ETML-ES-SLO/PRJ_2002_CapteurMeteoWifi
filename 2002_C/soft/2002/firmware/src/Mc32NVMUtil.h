...
/* Row size for pic32mx130 device is 128 bytes */
#define DEVICE_ROW_SIZE_DIVIDED_BY_4           32
/* Page size for pic32mx130 device is 1 Kbytes */
#define DEVICE_PAGE_SIZE_DIVIDED_BY_4           256

extern  const uint32_t  eedata_addr[DEVICE_ROW_SIZE_DIVIDED_BY_4 ] __attribute__((aligned(1024), space(prog)));
