...
//    if(Struct_save.BME280_save.Magic == 0x12345678)
//    {
//        BME280.Period = Struct_save.BME280_save.Period;
//        BME280.Altitude = Struct_save.BME280_save.Altitude;
