...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_U1CTS, INPUT_PIN_RPA1 );
    ...
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U1TX, OUTPUT_PIN_RPA0 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U1RTS, OUTPUT_PIN_RPA3 );
